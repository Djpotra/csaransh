...
config['filterZeroSizeClusters'] = False
config['isAddThresholdInterstitials'] = False
# config['isFindClusterFeatures'] = False
...
info['originType'] = 1
info['originFilePath'] = os.path.join(pathToCsaranshPP, "data", "1000.xyz")
info['ncell']=80
# info['boxSize'] = 80
...
# 1024000
print('Start processXyzFilesInDirGivenInfo')
xyzDir = os.path.join(pathToCsaranshPP, "data", "generic")
...
for cascade in cascades:
    ...
    # cnt=0
    # for coord in cascade['coords']:
    #     print(cnt,coord)
    #     cnt = cnt + 1
    # print(cascade['coDefects'])
    # print(cascade['coords'][4599])
# In[ ]:
...
supportDir = '../../csaransh_server/public/js'
...
#  --------------------------------
#  
#  returned with getDefaultConfig(). Can be changed such as `config['csaranshLib'] = "../libcsaransh-pp.dlib"`, `config['onlyDefects'] = True` etc.
