...
// csaransh::AddOffset::AddOffset(double latConst, std::string lattice,
//                                std::array<double, 3> origin,std::vector<std::array<double, 3>> &originAtoms) {
//   _origin = std::array<long double, 3>{{originAtoms[0][0], originAtoms[0][1], originAtoms[0][2]}};
//   _latConst = latConst;
//   if (lattice[0] == 'b') {
//     _bccUnitcell();
//   } else if (lattice[0] == 'f') {
